...
public class BadMutablePerson {
    ...
    private BadMutablePerson parent;
    
    public static void main(String args[]) {
        // Let's create a few objects
        BadMutablePerson p1 = 
            new BadMutablePerson("", "Mr. Incredible", 37, null);
    ...
    public BadMutablePerson(String familyName, String givenName, int age,
        BadMutablePerson parent) {
        // Here we make use of 'this' to differentiate between variables
        // with the same name
        this.familyName = familyName;
        this.givenName = givenName;
        this.age = age;
        this.parent = parent; // OH NO, A PRIVACY LEAK!
    }    
    ...
    public BadMutablePerson(String familyName, String givenName) {
        this.familyName = familyName;
        this.givenName = givenName;
        this.age = 0;
        this.parent = null;
    ...
    public BadMutablePerson(BadMutablePerson person) {
        ...
        if (person.parent != null) {
            ...
            this.parent = new BadMutablePerson(person.parent);
        } else {
            this.parent = null;
        }
    }        
    ...
    public BadMutablePerson getParent() {
        if (parent == null) {
            return null;
        }
        
        return new BadMutablePerson(parent);
    }
    ...
    // make a copy of it
    public void setParent(BadMutablePerson parent) {
        this.parent = new BadMutablePerson(parent);
    }
